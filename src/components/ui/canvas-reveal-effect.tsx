...
const ShaderMaterial = ({
 ...
 useFrame(({ clock }) => {
    ...
    const timeLocation = material.uniforms.u_time as THREE.Uniform<number>;
        ...
        case "uniform3f":
          preparedUniforms[uniformName] = {
            value: Array.isArray(uniform.value) 
              ? new THREE.Vector3().fromArray(uniform.value[0] as number[])
              : new THREE.Vector3(uniform.value, 0, 0),
            type: "3f",
          };
          break;
        case "uniform1fv":
